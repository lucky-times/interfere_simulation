function NR_throughput_half(SYS_config,ul_dl_wideband_loop_SINR,dl_ul_wideband_loop_SINR,activate_UE_id)
...
fid=fopen('.\calibration\Throughput loss half_asynchronization.txt','wt');
