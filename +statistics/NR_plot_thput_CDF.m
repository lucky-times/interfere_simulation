function NR_plot_thput_CDF(SYS_config,UEs,activate_UE_id)
% 绘制吞吐量cdf
% 输入参数：
% SYS_config：LTE参数系统
% UEs：UE列表
...
fprintf('DL average per cell: %f DL edge per cell: %f \n',thput_per_cell,thput_per_cell_5);
fprintf('UL average per cell: %f UL edge per cell: %f \n',ul_thput_per_cell,ul_thput_per_cell_5);
end