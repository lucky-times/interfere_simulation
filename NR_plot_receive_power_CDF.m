...
UE_Rx_power = real(10.*log10(UE_Rx_power));
UE_Rx_intf_power = real(10.*log10(UE_Rx_intf_power));
BS_Rx_power = real(10.*log10(BS_Rx_power));
BS_Rx_intf_power = real(10.*log10(BS_Rx_intf_power));
% plot
if SYS_config.photo
